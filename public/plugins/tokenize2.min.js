...
(function(a) {
    ...
    c.prototype.init = function() {
        ...
        this.container.on("focusin", e.proxy(function(f) {
            this.trigger("tokenize:select", [(e(f.target)[0] === this.tokensContainer[0])])
        }, this)).on("focusout", e.proxy(function() {
    ...
    c.prototype.reorder = function() {
        if (this.options.sortable) {
            ...
            e.each(g, e.proxy(function(j, i) {
                h = e('option[value="' + this.escapeQuery(i.value) + '"]', this.element);
                if (f === undefined) {
    ...
    c.prototype.tokenAdd = function(g, h, f) {
        ...
        if (e('li.token[data-value="' + this.escapeQuery(g) + '"]', this.tokensContainer).length > 0) {
            this.trigger("tokenize:tokens:error:duplicate", [g, h]);
            return this
        }
        if (e('option[value="' + this.escapeQuery(g) + '"]', this.element).length) {
            e('option[value="' + this.escapeQuery(g) + '"]', this.element).attr("selected", "selected").prop("selected", true)
        } else {
            if (f) {
    ...
    c.prototype.tokenRemove = function(g) {
        var f = e('option[value="' + this.escapeQuery(g) + '"]', this.element);
        if (f.attr("data-type") === "custom") {
            f.remove()
        } else {
            f.prop("selected", false)
        }
        e('li.token[data-value="' + this.escapeQuery(g) + '"]', this.tokensContainer).remove();
        this.trigger("tokenize:tokens:reorder");
            ...
            switch (g.keyCode) {
                case a.BACKSPACE:
                    if (this.input.val().length < 1) {
                        ...
                        if (e("li.token.pending-delete", this.tokensContainer).length > 0) {
                            e("li.token.pending-delete", this.tokensContainer).each(e.proxy(function(h, i) {
                                this.trigger("tokenize:tokens:remove", e(i).attr("data-value"))
                            }, this))
                        } else {
                ...
                case a.TAB:
                    if (!g.shiftKey) {
                        ...
                        this.tokensContainer.prop("tabindex", false)
                    }
                    break;
                case a.ENTER:
                    this.pressedDelimiter(g);
                ...
                case a.CTRL:
                    ...
                    break;
                default:
                    if (g.keyCode === a.A && this.control && this.input.val().length < 1) {
                        g.preventDefault();
                        e("li.token", this.tokensContainer).each(e.proxy(function(h, i) {
                            this.trigger("tokenize:tokens:markForDelete", [e(i).attr("data-value")]);
    ...
    c.prototype.dropdownAddItem = function(f) {
        if (this.isDropdownOpen()) {
            ...
            if (e('li.token[data-value="' + this.escapeQuery(g.find("a").attr("data-value")) + '"]', this.tokensContainer).length < 1) {
    ...
    c.prototype.escapeQuery = function(f) {
        f = String(f);
        if (f) {
            f = this.replaceAll(f, /\\/, "\\\\")
        }
    ...
    var i = {
        ...
        o = {
            ...
            onDrop: function(t, d, v, u) {
                t.removeClass(d.group.options.draggedClass).prop("style", null);
